...
void interconnects() {
    ...
    app_aes_start(
        dbg_peek_req, dbg_peek_resp, app_dram_read_req, app_dram_read_resp,
        app_dram_write_req_data, app_dram_write_req_apply, app_input_params,
        app_aes_proc_0_params, app_input_data, app_aes_proc_0_input_data);
    app_aes_process_0(app_aes_proc_0_params, app_aes_proc_1_params,
                      app_aes_proc_0_input_data, app_aes_proc_1_input_data);
    app_aes_process_1(app_aes_proc_1_params, app_aes_proc_2_params,
                      app_aes_proc_1_input_data, app_aes_proc_2_input_data);
    app_aes_process_2(app_aes_proc_2_params, app_aes_proc_3_params,
                      app_aes_proc_2_input_data, app_aes_proc_3_input_data);
    app_aes_process_3(app_aes_proc_3_params, app_aes_proc_4_params,
                      app_aes_proc_3_input_data, app_aes_proc_4_input_data);
    app_aes_process_4(app_aes_proc_4_params, app_aes_proc_5_params,
                      app_aes_proc_4_input_data, app_aes_proc_5_input_data);
    app_aes_process_5(app_aes_proc_5_params, app_aes_proc_6_params,
                      app_aes_proc_5_input_data, app_aes_proc_6_input_data);
    app_aes_process_6(app_aes_proc_6_params, app_aes_proc_7_params,
                      app_aes_proc_6_input_data, app_aes_proc_7_input_data);
    app_aes_process_7(app_aes_proc_7_params, app_aes_proc_8_params,
                      app_aes_proc_7_input_data, app_aes_proc_8_input_data);
    app_aes_process_8(app_aes_proc_8_params, app_aes_end_params,
                      app_aes_proc_8_input_data, app_aes_end_input_data);
