...
(* CORE_GENERATION_INFO="interconnects,hls_ip_2017_4_op,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcvu9p-flgb2104-2-i,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=2.916000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=1590,HLS_SYN_DSP=0,HLS_SYN_FF=43570,HLS_SYN_LUT=47332}" *)
...
wire    reset_propaganda_U0_reset_app_demo_dbg_peek_V_din;
wire    reset_propaganda_U0_reset_app_demo_dbg_peek_V_write;
...
wire    app_demo_dbg_peek_U0_ap_start;
wire    app_demo_dbg_peek_U0_ap_done;
wire    app_demo_dbg_peek_U0_ap_continue;
wire    app_demo_dbg_peek_U0_ap_idle;
wire    app_demo_dbg_peek_U0_ap_ready;
wire    app_demo_dbg_peek_U0_reset_app_demo_dbg_peek_V_dout;
wire    app_demo_dbg_peek_U0_reset_app_demo_dbg_peek_V_read;
wire    app_demo_dbg_peek_U0_dbg_peek_req_V_read;
wire   [31:0] app_demo_dbg_peek_U0_dbg_peek_resp_V_din;
wire    app_demo_dbg_peek_U0_dbg_peek_resp_V_write;
wire   [7:0] app_demo_dbg_peek_U0_app_dram_read_req_V_num_din;
wire    app_demo_dbg_peek_U0_app_dram_read_req_V_num_write;
wire   [63:0] app_demo_dbg_peek_U0_app_dram_read_req_V_addr_din;
wire    app_demo_dbg_peek_U0_app_dram_read_req_V_addr_write;
wire    app_demo_dbg_peek_U0_app_dram_read_resp_V_last_dout;
wire    app_demo_dbg_peek_U0_app_dram_read_resp_V_last_read;
wire    app_demo_dbg_peek_U0_app_dram_read_resp_V_data_V_read;
wire    app_demo_dbg_peek_U0_app_dram_write_req_data_V_last_din;
wire    app_demo_dbg_peek_U0_app_dram_write_req_data_V_last_write;
wire   [511:0] app_demo_dbg_peek_U0_app_dram_write_req_data_V_data_V_din;
wire    app_demo_dbg_peek_U0_app_dram_write_req_data_V_data_V_write;
wire   [7:0] app_demo_dbg_peek_U0_app_dram_write_req_apply_V_num_din;
wire    app_demo_dbg_peek_U0_app_dram_write_req_apply_V_num_write;
wire   [63:0] app_demo_dbg_peek_U0_app_dram_write_req_apply_V_addr_din;
wire    app_demo_dbg_peek_U0_app_dram_write_req_apply_V_addr_write;
wire    app_demo_dbg_peek_U0_app_input_data_V_data_V_read;
wire    app_demo_dbg_peek_U0_app_input_data_V_len_read;
wire    app_demo_dbg_peek_U0_app_input_data_V_eop_dout;
wire    app_demo_dbg_peek_U0_app_input_data_V_eop_read;
wire   [511:0] app_demo_dbg_peek_U0_app_output_data_V_data_V_din;
wire    app_demo_dbg_peek_U0_app_output_data_V_data_V_write;
wire   [15:0] app_demo_dbg_peek_U0_app_output_data_V_len_din;
wire    app_demo_dbg_peek_U0_app_output_data_V_len_write;
wire    app_demo_dbg_peek_U0_app_output_data_V_eop_din;
wire    app_demo_dbg_peek_U0_app_output_data_V_eop_write;
wire    app_demo_dbg_peek_U0_app_input_params_V_read;
...
wire   [0:0] reset_app_demo_dbg_peek_V_din;
wire    reset_app_demo_dbg_peek_V_full_n;
wire   [0:0] reset_app_demo_dbg_peek_V_dout;
wire    reset_app_demo_dbg_peek_V_empty_n;
wire    ap_sync_done;
wire    ap_sync_ready;
...
wire   [0:0] start_for_app_demo_dbg_peek_U0_din;
wire    start_for_app_demo_dbg_peek_U0_full_n;
wire   [0:0] start_for_app_demo_dbg_peek_U0_dout;
wire    start_for_app_demo_dbg_peek_U0_empty_n;
...
wire    app_demo_dbg_peek_U0_start_full_n;
wire    app_demo_dbg_peek_U0_start_write;
...
reset_propaganda reset_propaganda_U0(
    ...
    .reset_app_demo_dbg_peek_V_din(reset_propaganda_U0_reset_app_demo_dbg_peek_V_din),
    .reset_app_demo_dbg_peek_V_full_n(reset_app_demo_dbg_peek_V_full_n),
    .reset_app_demo_dbg_peek_V_write(reset_propaganda_U0_reset_app_demo_dbg_peek_V_write),
...
app_demo_dbg_peek app_demo_dbg_peek_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .ap_start(ap_start),
    .ap_done(app_demo_dbg_peek_U0_ap_done),
    .ap_continue(app_demo_dbg_peek_U0_ap_continue),
    .ap_idle(app_demo_dbg_peek_U0_ap_idle),
    .ap_ready(app_demo_dbg_peek_U0_ap_ready),
    .reset_app_demo_dbg_peek_V_dout(app_demo_dbg_peek_U0_reset_app_demo_dbg_peek_V_dout),
    .reset_app_demo_dbg_peek_V_empty_n(reset_app_demo_dbg_peek_V_empty_n),
    .reset_app_demo_dbg_peek_V_read(app_demo_dbg_peek_U0_reset_app_demo_dbg_peek_V_read),
    .dbg_peek_req_V_dout(dbg_peek_req_V_dout),
    .dbg_peek_req_V_empty_n(dbg_peek_req_V_empty_n),
    .dbg_peek_req_V_read(app_demo_dbg_peek_U0_dbg_peek_req_V_read),
    .dbg_peek_resp_V_din(app_demo_dbg_peek_U0_dbg_peek_resp_V_din),
    .dbg_peek_resp_V_full_n(dbg_peek_resp_V_full_n),
    .dbg_peek_resp_V_write(app_demo_dbg_peek_U0_dbg_peek_resp_V_write),
    .app_dram_read_req_V_num_din(app_demo_dbg_peek_U0_app_dram_read_req_V_num_din),
    .app_dram_read_req_V_num_full_n(app_dram_read_req_V_num_full_n),
    .app_dram_read_req_V_num_write(app_demo_dbg_peek_U0_app_dram_read_req_V_num_write),
    .app_dram_read_req_V_addr_din(app_demo_dbg_peek_U0_app_dram_read_req_V_addr_din),
    .app_dram_read_req_V_addr_full_n(app_dram_read_req_V_addr_full_n),
    .app_dram_read_req_V_addr_write(app_demo_dbg_peek_U0_app_dram_read_req_V_addr_write),
    .app_dram_read_resp_V_last_dout(app_demo_dbg_peek_U0_app_dram_read_resp_V_last_dout),
    .app_dram_read_resp_V_last_empty_n(app_dram_read_resp_V_last_empty_n),
    .app_dram_read_resp_V_last_read(app_demo_dbg_peek_U0_app_dram_read_resp_V_last_read),
    ...
    .app_dram_read_resp_V_data_V_read(app_demo_dbg_peek_U0_app_dram_read_resp_V_data_V_read),
    .app_dram_write_req_data_V_last_din(app_demo_dbg_peek_U0_app_dram_write_req_data_V_last_din),
    .app_dram_write_req_data_V_last_full_n(app_dram_write_req_data_V_last_full_n),
    .app_dram_write_req_data_V_last_write(app_demo_dbg_peek_U0_app_dram_write_req_data_V_last_write),
    .app_dram_write_req_data_V_data_V_din(app_demo_dbg_peek_U0_app_dram_write_req_data_V_data_V_din),
    .app_dram_write_req_data_V_data_V_full_n(app_dram_write_req_data_V_data_V_full_n),
    .app_dram_write_req_data_V_data_V_write(app_demo_dbg_peek_U0_app_dram_write_req_data_V_data_V_write),
    .app_dram_write_req_apply_V_num_din(app_demo_dbg_peek_U0_app_dram_write_req_apply_V_num_din),
    .app_dram_write_req_apply_V_num_full_n(app_dram_write_req_apply_V_num_full_n),
    .app_dram_write_req_apply_V_num_write(app_demo_dbg_peek_U0_app_dram_write_req_apply_V_num_write),
    .app_dram_write_req_apply_V_addr_din(app_demo_dbg_peek_U0_app_dram_write_req_apply_V_addr_din),
    .app_dram_write_req_apply_V_addr_full_n(app_dram_write_req_apply_V_addr_full_n),
    .app_dram_write_req_apply_V_addr_write(app_demo_dbg_peek_U0_app_dram_write_req_apply_V_addr_write),
    .app_input_data_V_data_V_dout(app_input_data_V_data_V_dout),
    .app_input_data_V_data_V_empty_n(app_input_data_V_data_V_empty_n),
    .app_input_data_V_data_V_read(app_demo_dbg_peek_U0_app_input_data_V_data_V_read),
    .app_input_data_V_len_dout(app_input_data_V_len_dout),
    .app_input_data_V_len_empty_n(app_input_data_V_len_empty_n),
    .app_input_data_V_len_read(app_demo_dbg_peek_U0_app_input_data_V_len_read),
    .app_input_data_V_eop_dout(app_demo_dbg_peek_U0_app_input_data_V_eop_dout),
    .app_input_data_V_eop_empty_n(app_input_data_V_eop_empty_n),
    .app_input_data_V_eop_read(app_demo_dbg_peek_U0_app_input_data_V_eop_read),
    .app_output_data_V_data_V_din(app_demo_dbg_peek_U0_app_output_data_V_data_V_din),
    .app_output_data_V_data_V_full_n(app_output_data_V_data_V_full_n),
    .app_output_data_V_data_V_write(app_demo_dbg_peek_U0_app_output_data_V_data_V_write),
    .app_output_data_V_len_din(app_demo_dbg_peek_U0_app_output_data_V_len_din),
    .app_output_data_V_len_full_n(app_output_data_V_len_full_n),
    .app_output_data_V_len_write(app_demo_dbg_peek_U0_app_output_data_V_len_write),
    .app_output_data_V_eop_din(app_demo_dbg_peek_U0_app_output_data_V_eop_din),
    .app_output_data_V_eop_full_n(app_output_data_V_eop_full_n),
    .app_output_data_V_eop_write(app_demo_dbg_peek_U0_app_output_data_V_eop_write),
    .app_input_params_V_dout(app_input_params_V_dout),
    .app_input_params_V_empty_n(app_input_params_V_empty_n),
    .app_input_params_V_read(app_demo_dbg_peek_U0_app_input_params_V_read)
);
...
fifo_w32_d4_A dbg_peek_req_V_U(
    ...
    .if_read(app_demo_dbg_peek_U0_dbg_peek_req_V_read)
);
...
fifo_w32_d4_A app_input_params_V_U(
    ...
    .if_read(app_demo_dbg_peek_U0_app_input_params_V_read)
);
...
fifo_w32_d4_A dbg_peek_resp_V_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(app_demo_dbg_peek_U0_dbg_peek_resp_V_din),
    .if_full_n(dbg_peek_resp_V_full_n),
    .if_write(app_demo_dbg_peek_U0_dbg_peek_resp_V_write),
...
fifo_w512_d4_A app_input_data_V_data_V_U(
    ...
    .if_read(app_demo_dbg_peek_U0_app_input_data_V_data_V_read)
);
...
fifo_w16_d4_A app_input_data_V_len_U(
    ...
    .if_read(app_demo_dbg_peek_U0_app_input_data_V_len_read)
);
...
fifo_w1_d4_A app_input_data_V_eop_U(
    ...
    .if_read(app_demo_dbg_peek_U0_app_input_data_V_eop_read)
);
...
fifo_w512_d4_A app_output_data_V_data_V_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(app_demo_dbg_peek_U0_app_output_data_V_data_V_din),
    .if_full_n(app_output_data_V_data_V_full_n),
    .if_write(app_demo_dbg_peek_U0_app_output_data_V_data_V_write),
...
fifo_w16_d4_A app_output_data_V_len_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(app_demo_dbg_peek_U0_app_output_data_V_len_din),
    .if_full_n(app_output_data_V_len_full_n),
    .if_write(app_demo_dbg_peek_U0_app_output_data_V_len_write),
...
fifo_w1_d4_A app_output_data_V_eop_U(
    ...
    .if_write(app_demo_dbg_peek_U0_app_output_data_V_eop_write),
...
fifo_w8_d64_A app_dram_read_req_V_num_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(app_demo_dbg_peek_U0_app_dram_read_req_V_num_din),
    .if_full_n(app_dram_read_req_V_num_full_n),
    .if_write(app_demo_dbg_peek_U0_app_dram_read_req_V_num_write),
...
fifo_w64_d64_A app_dram_read_req_V_addr_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(app_demo_dbg_peek_U0_app_dram_read_req_V_addr_din),
    .if_full_n(app_dram_read_req_V_addr_full_n),
    .if_write(app_demo_dbg_peek_U0_app_dram_read_req_V_addr_write),
...
fifo_w1_d64_A app_dram_read_resp_V_last_U(
    ...
    .if_read(app_demo_dbg_peek_U0_app_dram_read_resp_V_last_read)
);
...
fifo_w512_d64_A app_dram_read_resp_V_data_V_U(
    ...
    .if_read(app_demo_dbg_peek_U0_app_dram_read_resp_V_data_V_read)
);
...
fifo_w1_d64_A app_dram_write_req_data_V_last_U(
    ...
    .if_write(app_demo_dbg_peek_U0_app_dram_write_req_data_V_last_write),
...
fifo_w512_d64_A app_dram_write_req_data_V_data_V_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(app_demo_dbg_peek_U0_app_dram_write_req_data_V_data_V_din),
    .if_full_n(app_dram_write_req_data_V_data_V_full_n),
    .if_write(app_demo_dbg_peek_U0_app_dram_write_req_data_V_data_V_write),
...
fifo_w8_d64_A app_dram_write_req_apply_V_num_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(app_demo_dbg_peek_U0_app_dram_write_req_apply_V_num_din),
    .if_full_n(app_dram_write_req_apply_V_num_full_n),
    .if_write(app_demo_dbg_peek_U0_app_dram_write_req_apply_V_num_write),
...
fifo_w64_d64_A app_dram_write_req_apply_V_addr_U(
    ...
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(app_demo_dbg_peek_U0_app_dram_write_req_apply_V_addr_din),
    .if_full_n(app_dram_write_req_apply_V_addr_full_n),
    .if_write(app_demo_dbg_peek_U0_app_dram_write_req_apply_V_addr_write),
...
fifo_w1_d4_A reset_app_demo_dbg_peek_V_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(reset_app_demo_dbg_peek_V_din),
    .if_full_n(reset_app_demo_dbg_peek_V_full_n),
    .if_write(reset_propaganda_U0_reset_app_demo_dbg_peek_V_write),
    .if_dout(reset_app_demo_dbg_peek_V_dout),
    .if_empty_n(reset_app_demo_dbg_peek_V_empty_n),
    .if_read(app_demo_dbg_peek_U0_reset_app_demo_dbg_peek_V_read)
);
...
start_for_app_demo_dbg_peek_U0 start_for_app_demo_dbg_peek_U0_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
    .if_din(start_for_app_demo_dbg_peek_U0_din),
    .if_full_n(start_for_app_demo_dbg_peek_U0_full_n),
    .if_write(poke_handler_U0_start_write),
    .if_dout(start_for_app_demo_dbg_peek_U0_dout),
    .if_empty_n(start_for_app_demo_dbg_peek_U0_empty_n),
    .if_read(app_demo_dbg_peek_U0_ap_ready)
);
...
assign app_demo_dbg_peek_U0_ap_continue = 1'b1;

assign app_demo_dbg_peek_U0_ap_start = start_for_app_demo_dbg_peek_U0_empty_n;

assign app_demo_dbg_peek_U0_app_dram_read_resp_V_last_dout = app_dram_read_resp_V_last_dout;

assign app_demo_dbg_peek_U0_app_input_data_V_eop_dout = app_input_data_V_eop_dout;

assign app_demo_dbg_peek_U0_reset_app_demo_dbg_peek_V_dout = reset_app_demo_dbg_peek_V_dout;

assign app_demo_dbg_peek_U0_start_full_n = 1'b1;

assign app_demo_dbg_peek_U0_start_write = 1'b0;

assign app_dram_read_resp_V_last_din = dram_C_D_to_app_U0_app_dram_read_resp_V_last_din;

assign app_dram_write_req_data_V_last_din = app_demo_dbg_peek_U0_app_dram_write_req_data_V_last_din;
...
assign app_output_data_V_eop_din = app_demo_dbg_peek_U0_app_output_data_V_eop_din;
...
assign reset_app_demo_dbg_peek_V_din = reset_propaganda_U0_reset_app_demo_dbg_peek_V_din;
...
assign start_for_app_demo_dbg_peek_U0_din = 1'b1;
