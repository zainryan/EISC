...
void interconnects() {
  ...
  app_rlf_dspt(dbg_peek_req, dbg_peek_resp, app_dram_read_req,
               app_dram_read_resp, app_dram_write_req_data,
               app_dram_write_req_apply, app_input_params, app_input_data,
               app_rlf_upd_input_params, app_rlf_dist_input_params,
               app_rlf_diff_input_params, app_rlf_dist_input_data,
               app_rlf_flt16_input_data, app_rlf_max_vec_init);
