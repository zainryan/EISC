...
int main() {
  ...
  ST_Queue<bool> reset_app_demo_dram_and_dbg(4);
  ...
  std::thread t35(
      reset_propaganda, std::ref(reset_app_demo_dram_and_dbg),
      ...
      std::ref(reset_app_input_data_merger),
      std::ref(reset_write_mode_pre_merged_app_input_data_forwarder));
  std::thread t36(app_demo_dram_and_dbg, std::ref(reset_app_demo_dram_and_dbg),
